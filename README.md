...
Você acaba de instalar o JN-IA OS. Em alguns minutos, sua empresa vai
...
```
Clona o https://github.com/jaum747-hash/JN-IA-OS.git na pasta atual,
...
```
git clone https://github.com/jaum747-hash/JN-IA-OS.git
cd JN-IA-OS
code .
```
...
Quando o `/instalar` terminar, renomeia a pasta `JN-IA-OS/` pro nome do teu
negócio (fecha o VS Code, renomeia no Explorer/Finder, abre de novo). A
pasta não fica como "JN-IA OS" — ela é o teu negócio agora.
...
closed loop dentro do JN-IA OS (decide → executa → captura → realimenta →
ajusta sozinho).
