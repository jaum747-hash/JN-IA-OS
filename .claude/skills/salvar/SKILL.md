...
name: salvar
description: >
  Salva o trabalho do JN-IA OS no GitHub (commit + push). Na primeira vez configura o repositório
...
1. Perguntar:
   ...
   > 2. Não, vou criar agora — me dá um nome pro repositório (ex: minha-jn-ia-os)"

2. **Se opção 1:** rodar `git init`, `git add .`, `git commit -m "Setup inicial do JN-IA OS"`, `git branch -M main`, `git remote add origin <URL>`, `git push -u origin main`.
